...
if [[ $KERNELSU = "true" ]]; then
    curl -LSs "https://raw.githubusercontent.com/rsuntkOrgs/KernelSUonARM32/main/kernel/setup.sh" | bash -s main
else
    echo -e "KernelSU is disabled. Use KERNELSU=true to enable"
fi
